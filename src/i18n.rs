...
const ZH_SOURCE: &[(&str, &str)] = &[
    ...
    ("update.settings_title", "软件更新"),
    ("update.auto_check", "启动时自动检查更新"),
    ("update.auto_check_hint", "后台检查 GitHub Releases，发现新版只在顶部提示，不自动下载或安装。"),
    ("update.available_button", "更新"),
    ...
    ("settings.ai_commit_language", "提交信息语言"),
    ("settings.ai_commit_language_english", "英文"),
    ("settings.ai_commit_language_chinese", "中文"),
...
const EN: &[(&str, &str)] = &[
    ...
    ("update.settings_title", "Software updates"),
    ("update.auto_check", "Check for updates automatically on startup"),
    ("update.auto_check_hint", "Check GitHub Releases in the background and show a title-bar notice. Nothing is downloaded or installed automatically."),
    ("update.available_button", "Update"),
    ...
    ("settings.ai_commit_language", "Commit message language"),
    ("settings.ai_commit_language_english", "English"),
    ("settings.ai_commit_language_chinese", "Chinese"),
    ...
    ("commit.panel", "Commit"),
    ("commit.ai_generate", "AI generate"),
    ("commit.ai_working", "AI working…"),
    ("commit.ai_cancel", "Cancel"),
    ("commit.ai_stopping", "Stopping (waiting for the current request)…"),
    ("commit.ai_model", "Model"),
    ("commit.ai_hint", "Requires staged changes and a model in Options > AI. Not available for amend/rebase."),
    ("commit.ai_privacy", "Click to generate and replace the commit editor text directly; nothing is committed or pushed. Sends staged diffs and requested related tracked code to this AI provider. Unstaged content is excluded. Check for secrets first; filename filtering cannot detect every secret. Provider charges may apply."),
    ("commit.ai_draft_changed", "The commit draft changed during generation. Your edits were kept; generate again if needed."),
    ("commit.ai_disconnected", "AI commit task stopped unexpectedly. Please retry."),
    ...
    ("search.running", "Searching history contents… Filename matches appear first."),
    ("search.cancel", "Cancel search"),
    ("search.cancelled", "Search cancelled. Any filename matches have been kept."),
    ("search.timeout", "Search exceeded 120 seconds and was stopped. Any filename matches have been kept; content results are incomplete. Try a more specific query."),
    ("search.failed", "Commit search failed. Git diagnostics:"),
    ("search.disconnected", "The commit search task stopped unexpectedly. Please retry."),
    ("search.partial", "Partial results only: filename matches. Content search did not finish."),
    ("search.incomplete_empty", "Search is incomplete; this does not mean there are no matches."),
...
const ZH: &[(&str, &str)] = &[
    ...
    ("commit.parents", "父提交"),
    ("commit.panel", "提交"),
    ("commit.ai_generate", "AI 生成"),
    ("commit.ai_working", "AI 处理中…"),
    ("commit.ai_cancel", "取消"),
    ("commit.ai_stopping", "正在停止（等待当前请求结束）…"),
    ("commit.ai_model", "模型"),
    ("commit.ai_hint", "需要暂存改动，并在选项 > AI 中配置模型。修改最后一次提交及变基时暂不提供此功能。"),
    ("commit.ai_privacy", "点击即开始生成，完成后直接替换提交框文本，不会自动提交或推送。会将暂存差异及按需读取的相关已跟踪代码发送给此 AI 服务商，不读取未暂存内容。请先确认没有敏感信息；文件名过滤无法识别所有密钥。服务商可能收取费用。"),
    ("commit.ai_draft_changed", "生成期间提交草稿已发生变化，已保留你的编辑；如需 AI 内容，请重新生成。"),
    ("commit.ai_disconnected", "AI 提交信息任务意外中断，请重试。"),
    ("commit.message", "提交信息"),
    ...
    ("search.running", "正在搜索历史内容… 文件名匹配会先显示。"),
    ("search.cancel", "取消搜索"),
    ("search.cancelled", "搜索已取消，已保留找到的文件名匹配。"),
    ("search.timeout", "搜索超过 120 秒，已停止。已保留找到的文件名匹配，内容搜索结果不完整；可尝试更具体的关键词。"),
    ("search.failed", "提交搜索失败。Git 原始诊断："),
    ("search.disconnected", "提交搜索任务意外中断，请重试。"),
    ("search.partial", "当前仅为文件名匹配的部分结果，历史内容搜索尚未完成。"),
    ("search.incomplete_empty", "搜索尚未完成，不代表没有匹配的提交。"),
